// https://raw.githubusercontent.com/vtex-apps/add-to-cart-button/a82400c526ac8d98e4a751dbcc434cb79c0c289a/react/modules/catalogItemToCart.ts
...
export function mapCatalogItemToCart({
  ...
  if (!product || !selectedItem || !selectedSeller || !selectedSeller.commertialOffer) {
    return [];
  }
  ...
  return [
    {
      ...
      sellingPriceWithAssemblies:
        ((selectedSeller.commertialOffer.Price as number) + sumAssembliesPrice(assemblyOptions?.items ?? {})) * 100,
